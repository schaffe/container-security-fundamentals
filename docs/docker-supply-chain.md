...
- **User namespaces:** CLONE_NEWUSER, UID/GID mapping, /etc/subuid, /etc/subgid, --userns-remap, rootless Docker and Podman, per-pod user namespaces (K8s 1.27+), interaction with capabilities and other namespaces.
